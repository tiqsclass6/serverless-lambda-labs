...
CLIENT_ID = "122h86hbblnmbntaofnqrroldr"
REGION = "us-east-1"

API_BASE = "https://84394npi29.execute-api.us-east-1.amazonaws.com/prod"
...
try:
    ...
    print(f'''curl "{API_BASE}/python?name=Chewbacca" \\
  -H "Authorization: {access_token}"
''')

    print("\nNode Endpoint:\n")

    print(f'''curl "{API_BASE}/node?name=Malgus" \\
  -H "Authorization: {access_token}"
''')
